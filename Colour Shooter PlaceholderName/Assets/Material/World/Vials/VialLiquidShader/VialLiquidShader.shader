Shader "Custom/VialLiquidShader" {
Properties
    {
    ...
    SubShader
    {
                ...
                Pass
        {
         ...
         fixed4 frag (v2f i, fixed facing : VFACE) : SV_Target
         {
		   ...
		   float noiseSample = tex2Dlod(_NoiseTex, float4(i.uv.xy,0,0)/50);
			//i.fillEdge += sin(_Time*_WaveSpeed*noiseSample)*_WaveAmp+_ExtraHeight;
			float quickTime = 1;
			i.fillEdge += cos(quickTime*_WaveSpeed*noiseSample)*_WaveAmp;
		   // rest of the liquid
